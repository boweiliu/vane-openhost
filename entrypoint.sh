...
if [ -n "$OPENHOST_APP_DATA_DIR" ]; then
  echo "Using OpenHost app data directory: $OPENHOST_APP_DATA_DIR"
  mkdir -p "$OPENHOST_APP_DATA_DIR/data" "$OPENHOST_APP_DATA_DIR/uploads"
  ln -sfn "$OPENHOST_APP_DATA_DIR/data" /home/vane/data
